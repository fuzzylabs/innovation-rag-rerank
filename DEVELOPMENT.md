...
This document contains documentation intended for developers of rag_retrieval_rerank.
...
## First time setup
If you're creating rag_retrieval_rerank for the first time, you'll need to configure your local development environment along with the remote repository.
...
To work on the rag_retrieval_rerank as a developer, you'll need to configure your local development environment. You can do this by simply running:
```bash
make project-setup
```
